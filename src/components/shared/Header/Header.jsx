...
const Header = ({ title, subTitle, Img, width = '65%' }) => {
    return (
        <div className={`rounded-[1.2rem] flex justify-between relative items-center max-md:w-full md:w-[${width}] bg-white shadow-xl aspect-[16/4] h-full`}>
