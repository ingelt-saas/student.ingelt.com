    ...
    <div className={`w-full flex flex-row ${isStudentMessage ? 'justify-end' : 'justify-start'}`}>
      ...
      {!isStudentMessage && <div className="w-fit md:max-w-[70%] max-w-[82%] flex flex-row items-end">
        ...
        <div className="flex flex-col gap-y-1 flex-1">
          ...
          {discussionReports.length > 0 && <span className="!text-xs text-[#1b3b7d] font-medium">{reporterFind ? (discussionReports.length <= 1 ? 'You report this message' : `You & ${discussionReports.length - 1} people reported this message`) : `${discussionReports.length} people reported this message`}</span>}
        </div>
