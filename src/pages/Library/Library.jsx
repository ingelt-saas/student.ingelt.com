...
const LandingPage = () => {
    ...
    // enter click handler
    const unlockLibrary = async (e) => {
        e.target.disabled = true;
        try {
            await settings.update({ libraryUnlock: true });
    ...
    return <div className="w-full min-h-full max-sm:px-3 py-10 bg-[#001E43] grid place-items-center">
        <div className="flex flex-col items-center gap-y-8">
            ...
            <div className="flex items-center max-md:flex-col max-md:gap-y-10 gap-x-6">
                ...
                <div className="md:w-1/2">
                    <div className="md:w-10/12 md:ml-auto">
