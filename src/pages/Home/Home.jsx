    ...
    return (
        <div className='pt-5'>
            <div className='grid grid-cols-1 md:grid-cols-12 gap-3 xl:gap-5'>
                ...
                {/* profile info */}
                <div className='rounded-lg bg-white shadow-lg px-4 py-5 flex gap-x-4 md:col-span-12 lg:col-span-5 items-center'>
                    <div className='w-1/2'>
                        <div className=''>
                ...
                {/* speaking practice */}
                <div className='md:col-span-12 flex max-md:flex-col max-md:gap-y-6 items-center rounded-lg overflow-hidden justify-between bg-cover bg-no-repeat bg-center py-3 px-5 shadow-lg' style={{ backgroundImage: `url(${img1})` }}>
