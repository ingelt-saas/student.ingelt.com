    ...
    <>
      <div className="grid grid-cols-6 gap-x-5 w-full">
        <div className="col-span-4">
          <div className="">
            <div className="relative rounded-xl mt-10 shadow-lg w-11/12">
              <img
                src={welcomeSVG}
                alt="welcome svg"
            ...
            <div className="mt-10 border-2 border-[#78787840] shadow-sm rounded-lg py-5 flex">
                ...
                <div className="w-full grid grid-cols-2 gap-y-5 gap-x-3 ">
                  <div className="flex items-center gap-x-3">
                    ...
                    >
                      ...
                      <path
                        d="M11 37.4139C11 31.9079 15.6 27.4444 25 27.4444C34.4 27.4444 39 31.9079 39 37.4139C39 38.2899 38.3609 39 37.5726 39H12.4275C11.6391 39 11 38.2899 11 37.4139Z"
                        stroke="white"
                        strokeWidth="2"
                      />
                      <path
                        d="M30.25 16.25C30.25 19.1495 27.8995 21.5 25 21.5C22.1005 21.5 19.75 19.1495 19.75 16.25C19.75 13.3505 22.1005 11 25 11C27.8995 11 30.25 13.3505 30.25 16.25Z"
                        stroke="white"
                        strokeWidth="2"
                      />
                    </svg>
                    <div className="flex-1">
                      ...
                      <p className="text-black text-base font-semibold break-words">
                        Mukul Rathee
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-x-3">
                    ...
                    >
                      <circle cx="25" cy="25" r="25" fill="#0064E1" />
                      <path
                        d="M25 41.8421C25 41.8421 38 30.4188 38 21.8513C38 14.7537 32.1797 9 25 9C17.8203 9 12 14.7537 12 21.8513C12 30.4188 25 41.8421 25 41.8421Z"
                        stroke="white"
                        strokeWidth="3"
                      />
                      <path
                        d="M29.1533 21.3161C29.1533 23.5833 27.294 25.4213 25.0005 25.4213C22.707 25.4213 20.8478 23.5833 20.8478 21.3161C20.8478 19.0488 22.707 17.2108 25.0005 17.2108C27.294 17.2108 29.1533 19.0488 29.1533 21.3161Z"
                        stroke="white"
                        strokeWidth="3"
                      />
                    </svg>
                  ...
                  <div className="flex items-center gap-x-3">
                    ...
                    >
                      <circle cx="25" cy="25" r="25" fill="#0064E1" />
                      <path
                        d="M12.75 16.7757L25 24.7665L38.125 16.7757M14.5 36C12.567 36 11 34.41 11 32.4485V18.5515C11 16.59 12.567 15 14.5 15H35.5C37.433 15 39 16.59 39 18.5515V32.4485C39 34.41 37.433 36 35.5 36H14.5Z"
                        stroke="white"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <div className="border-2 border-[#78787840] mt-10 rounded-lg px-4 py-5">
              <StudentGraph />
            </div>
          </div>
        </div>
        ...
        <div className="col-span-2">
          <div>
            <div className="border-b-2 border-r-2 rounded-xl border-[#78787840] flex">
              ...
              <div className="w-8/12 flex flex-col justify-between py-2">
                <div>
                  ...
                  <p className="truncate relative pr-6 py-1">
                    ...
                    <button className="text-black absolute top-1/2 right-2 -translate-y-1/2">
                      ...
                      >
                        <path
                          d="M16.6663 1.04297H4.16634C3.02051 1.04297 2.08301 1.98047 2.08301 3.1263V17.7096H4.16634V3.1263H16.6663V1.04297ZM19.7913 5.20964H8.33301C7.18717 5.20964 6.24967 6.14714 6.24967 7.29297V21.8763C6.24967 23.0221 7.18717 23.9596 8.33301 23.9596H19.7913C20.9372 23.9596 21.8747 23.0221 21.8747 21.8763V7.29297C21.8747 6.14714 20.9372 5.20964 19.7913 5.20964ZM19.7913 21.8763H8.33301V7.29297H19.7913V21.8763Z"
                          fill="black"
                        />
                      </svg>
                    </button>
                ...
                <button className="px-5 py-2 rounded-lg bg-[#609EEC66] font-semibold w-fit">
                  Join Meeting
                </button>
              </div>
            </div>

            <div className="mt-10 border-2 border-[#78787840] rounded-md py-6 px-3">
            ...
            <div className="rounded-lg p-2 bg-[#0064E11A]">
              <div className="flex flex-col items-center gap-3 bg-[#fff] rounded-lg py-3">
                ...
                >
                  ...
                  <path
                    d="M41.6667 66.2222V49.5556M50 66.2222V52.3333M58.3333 66.2222V44M63.8889 24.5556H75V80.1111H25V24.5556H36.1111M36.1111 19H63.8889V30.1111H36.1111V19Z"
                    stroke="white"
                    strokeWidth="5"
                  />
                </svg>
                <h1 className="text-[#787878] text-xl font-semibold">
                  Average Score
                </h1>
