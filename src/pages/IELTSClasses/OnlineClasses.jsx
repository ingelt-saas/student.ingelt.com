          ...
          <div className="md:w-9/12">
            ...
            <div className="mt-7 md:pr-3">
              ...
              <ul className=" list-disc pl-4 space-y-2 mt-5">
                ...
                <li>Formal vs Informal Expressions</li>
                <li>Tenses</li>
                <li>International Phonetic Alphabet</li>
                <li>Modals</li>
                <li>Techniques to speak fluently</li>
                <li>Listening Drill</li>
                <li>Techniques to improve vocabulary</li>
                <li>Idioms and Phrases</li>
                <li>Homophones</li>
                <li>Basics of Writing Skills</li>
          ...
          {isPay ? (
            ...
            <>
              <div className="rounded-xl overflow-hidden relative">
                ...
                />
                <h3 className="text-2xl whitespace-nowrap font-semibold text-white absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2">
