...
// assets
import moduleImg from "../../assets/images/IELT Pre.svg";
        ...
        >
          ...
          <Box sx={{ width: { md: "30%", xs: "100%" } }}>
            <img
              src={moduleImg}
              alt="library"
              className="relative bottom-1  left-40 "
            />
          </Box>
        </Box>
      </div>
            ...
            <div className="grid 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 gap-y-5 pt-10">
              {modules.map((item, index) => (
                <div
                  ...
                  className="p-3 bg-white rounded-xl h-full shadow-[0px_10px_36px_rgba(0,0,0,0.16),0px_0px_0px_1px_rgba(0,0,0,0.06)] scale-95 hover:scale-100 duration-200 transition-transform cursor-pointer"
                  key={index}
                >
                  <div className="rounded-2xl h-44 overflow-hidden">
                    <Image
